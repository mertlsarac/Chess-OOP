...
public class Board {
	...
	//get the point where the piece wants to move, if it's a friendly piece, return false. if that piece is an enemy piece, add it to possibleMove and return false
	...
	//when a piece moves, if there is an enemy piece there, remove this piece from pieces ArrayList.
	...
	//if there is "check" situation, return this player's color
	public PieceColor checkMate(Game game) {
		...
		//if there is no threats, return null
		return null;
	}
